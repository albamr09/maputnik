...
import { disableAllMaplibreGlDebugOptions, enableAllMaplibreGlDebugOptions, selectMaplibreGlDebugOptions, setMaplibreGlDebugOptions } from "@/store/slices/styleSlice";
      ...
      <div className="flex flex-col gap-5 px-2">
        ...
        <div className="flex gap-3 justify-between">
          <Button className="flex-1"
            onClick={() => { dispatch(enableAllMaplibreGlDebugOptions()) }}
          >
            {t("Enable All")}
          </Button>
          <Button className="flex-1"
            onClick={() => { dispatch(disableAllMaplibreGlDebugOptions()) }}
          >
            {t("Clear All")}
          </Button>
        </div>
