...
export interface FieldProps {
	...
	labelAlignment?: keyof typeof labelAlignmentClasses;
	rowDistribution?: keyof typeof rowDistributionClasses;
	inputAlignment?: keyof typeof inputAlignmentClasses;
...
export const Field: React.FC<FieldProps> = ({
	...
	return (
		...
		>
			{showLabel && (
				<div
					className={cn(
						...
						labelAlignmentClasses[labelAlignment],
					)}
				>
			...
			>
				<div className={cn("flex", inputAlignmentClasses[inputAlignment])}>
					{children}
				</div>
