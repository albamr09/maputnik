      ...
      layers.forEach((layer, idxInGroup) => {
        ...
        const listItem = (
          <LayerListItem
            ...
            onLayerFloorFilterToggle={this.props.onLayerFloorFilterToggle.bind(
              this,
            )}
            {...additionalProps}
          />
...
const LayerListContainerSortable = SortableContainer(
  (props: LayerListContainerProps) => <LayerListContainer {...props} />,
);
